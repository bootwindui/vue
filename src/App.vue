    ...
    <div class="w-full lg:w-5/6">
      <div class="flex flex-wrap fixed top-0 right-0 bg-indigo-800 text-white w-full shadow-sm p-2 lg:px-6 z-40">
            ...
            <h1 class=" p-1  font-bold text-lg text-center flex flex-wrap">
                ...
                <router-link class="font-semibold text-2xl tracking-tight ml-3" to="/">
                 BootWind
                </router-link>
            </h1>
            <div class="ml-auto p-1 text-md" >
              <div class="flex flex-wrap">
                 <a target="_blank" href="https://github.com/bootwind-template" class="cursor-pointer px-4 p-1 shadow-lg text-indigo-800 bg-indigo-100 hover:bg-indigo-200 rounded-full text-indigo-100 flex">
      ...
      <router-view class="bg-gray-100 pt-16 p-3 min-h-screen"/>

          <!-- <div v-if="alert" class="p-2 px-3 bg-indigo-800 items-center text-indigo-100  rounded-lg flex  flex-wrap fixed top-0 right-0 max-w-md m-1 border-2 border-gray-100 shadow-lg lg:mr-8 lg:mt-8 z-50" >
