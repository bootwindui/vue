<template>
    <div class="flex flex-wrap">
             ...
             <li class="p-2">
                ...
                <div class="text-default relative" >
                    <div v-for="(data,i) in listCarousel" :key="i" >
                        <span v-if="carouselActive == i" >
                            <div class="flex flex-wrap text-center border rounded-xl neu-in">
                                ...
                                <div class="w-full px-4 flex flex-col">
                                    ...
                                    <span class="py-3">
                                        <a href="#" class="neu-out rounded-full px-4 py-2">Go somewhere {{ i+1 }}</a>
                                    </span>
                                </div>
                     ...
                     <span @click="carouselTo('prev')" class="rounded-full mx-2 cursor-pointer p-3 neu-out absolute left-0 z-20 " style="top:40%">
                    ...
                    <span @click="carouselTo('next')"  class="rounded-full mx-2 cursor-pointer p-3 neu-out absolute right-0 z-20 " style="top:40%">
        ...
        <right-menu class="w-full lg:w-1/3 shadow-sm p-2 lg:p-12" youtube="laI_rwHPnNM" next="breadcrumb" back="alert" />
    </div>
</template>
<script>
import Vue from 'vue'
