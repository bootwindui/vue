...
button3: ` <button type="button" class="px-6 py-2 shadow-md hover:shadow-lg m-1 bg-blue-600 hover:bg-blue-700  text-white rounded-md">Primary</button>
  <button type="button" class="px-6 py-2 shadow-md hover:shadow-lg m-1 bg-gray-600 hover:bg-gray-700 text-white rounded-md">Secondary</button>
  <button type="button" class="px-6 py-2 shadow-md hover:shadow-lg m-1 bg-green-600 hover:bg-green-700 text-white rounded-md"> Success </button>
  <button type="button" class="px-6 py-2 shadow-md hover:shadow-lg m-1 bg-red-600 hover:bg-red-700 text-white rounded-md"> Danger </button>
  <button type="button" class="px-6 py-2 shadow-md hover:shadow-lg m-1 bg-yellow-600 hover:bg-yellow-700 text-white rounded-md">Warning</button>
  <button type="button" class="px-6 py-2 shadow-md hover:shadow-lg m-1 bg-blue-600 hover:bg-blue-700 text-white rounded-md">Info</button>`,
button4: ` <div class="flex">
  <input type="text" class=" max-w-md rounded-l bg-gray-200 appearance-none border-2 border-gray-200 w-full py-2 px-6 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-indigo-700" placeholder="Input group example">
  <button type="button" class="rounded-r py-2 px-6 shadow-md hover:shadow-lg bg-indigo-700 hover:bg-indigo-700  text-white">Button</button>
</div>`
    }
  }
}
