<template>
    <div class="flex flex-wrap">
        ...
        <ul class="w-full lg:w-1/2">
            ...
            <li class="p-2">
              <h1 class="p-2">Button Group</h1>
                <bw-com :data="button4"  />             
            </li>
        </ul>
        <right-menu class="w-full lg:w-1/2 shadow-md p-2 lg:p-12" youtube="D0dJYE5Dc1o" next="card" back="breadcrumb" />
    </div>
</template>
...
export default {
  ...
  data(){
    return {
button1 : `<button class="bg-indigo-700 hover:bg-indigo-800 text-white font-bold py-2 px-6 m-1 rounded">
  Style 1
</button>
<button class="bg-gray-300 hover:bg-gray-400 font-bold  py-2 px-6 m-1 rounded-full">
  Style 2
</button>
<button class="bg-transparent hover:bg-gray-800 text-gray-800  font-semibold hover:text-gray-100 py-2 px-6 m-1 border border-gray-800 hover:border-transparent rounded">
  Style 3
</button>
<button class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold py-2 px-6  rounded inline-flex items-center m-2" >
  <svg class="fill-current w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M13 8V2H7v6H2l8 8 8-8h-5zM0 18h20v2H0v-2z"/></svg>
  <span>Btn Icon</span>
</button>`,
button2: ` <button  class="
    font-bold cursor-pointer px-6 p-1 shadow-lg bg-indigo-800 text-indigo-100 
    hover:bg-indigo-200 rounded-full flex w-full">
...
button3: ` <button type="button" class="px-6 py-2 shadow-md hover:shadow-lg m-1 bg-blue-600 hover:bg-blue-800  text-white rounded-md">Primary</button>
  <button type="button" class="px-6 py-2 shadow-md hover:shadow-lg m-1 bg-gray-600 hover:bg-gray-800 text-white rounded-md">Secondary</button>
  <button type="button" class="px-6 py-2 shadow-md hover:shadow-lg m-1 bg-green-600 hover:bg-green-800 text-white rounded-md"> Success </button>
  <button type="button" class="px-6 py-2 shadow-md hover:shadow-lg m-1 bg-red-600 hover:bg-red-800 text-white rounded-md"> Danger </button>
  <button type="button" class="px-6 py-2 shadow-md hover:shadow-lg m-1 bg-yellow-600 hover:bg-yellow-800 text-white rounded-md">Warning</button>
  <button type="button" class="px-6 py-2 shadow-md hover:shadow-lg m-1 bg-blue-600 hover:bg-blue-800 text-white rounded-md">Info</button>`,
button4: ` <div class="flex">
  <input type="text" class=" max-w-md rounded-l bg-gray-200 appearance-none border-2 border-gray-200 w-full py-2 px-6 text-gray-800 leading-tight focus:outline-none focus:bg-white focus:border-indigo-700" placeholder="Input group example">
  <button type="button" class="rounded-r py-2 px-6 shadow-md hover:shadow-lg bg-indigo-700 hover:bg-indigo-800  text-white">Button</button>
</div>`
    }
  }
}
